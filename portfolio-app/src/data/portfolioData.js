export const profile = {
  ...
  portfolioUrl: "https://evan-yoon.com",
  portfolioDisplay: "evan-yoon.com",
  githubLabel: "GitHub",
...
export const hero = {
  aboutTitle: "About Me",
  aboutLines: [
    "HR and customer support background turned solution builder.",
    "Now focused on applied AI, product delivery, and customer-facing technical problem solving.",
  ],
  blocks: [
    {
      title: "Background",
      lines: [
        "HR / GA operations",
        "Customer support at Blizzard",
        "Applied AI transition through product building",
      ],
    },
    {
      title: "What I Do",
  ...
  quickFacts: [
    {
      label: "Focus",
      value: "Applied AI / Product Prototyping / Solution Design",
    },
    { label: "Strength", value: "Business context + technical execution" },
    { label: "Keywords", value: "Customer thinking, MVP, system design" },
  ],
};
